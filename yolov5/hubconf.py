...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from utils_yolov5.downloads import attempt_download
    from utils_yolov5.general import LOGGER, check_requirements, intersect_dicts, logging
...
if __name__ == '__main__':
    ...
    from utils_yolov5.general import cv2
